...
class PostPage extends StatefulWidget {
  ...
  final String title, desc, date, avatarUrlAuthor, img, link;
  final int id;
  PostPage({this.id, this.title, this.desc, this.date, this.avatarUrlAuthor, this.img, this.link});
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 8),
            Text(widget.title, style: AppStyle.titleBlack),
            SizedBox(height: 6),
            Row(
